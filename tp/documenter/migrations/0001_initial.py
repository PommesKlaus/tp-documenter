# -*- coding: utf-8 -*-
# Generated by Django 1.10.4 on 2016-12-03 22:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='documenter.Category')),
                ('supplier', models.ManyToManyField(related_name='dealing_as_supplier', to='documenter.Company')),
            ],
        ),
    ]
